                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('addtrendinggame') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gamename" class="form-control" id="exampleInputUsername1"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="discountprice" class="form-control" id="exampleInputDiscountPrice"
