            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td class="align-center" width="100%">
                  <a href="https://postdrop.io"><img src="{{URL::asset('assets/images/logo.png')}}"></a>
                </td>
              </tr>
            </table>
          </div>
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>👋&nbsp; Welcome to LugX. A website of gamings.</p>

                        <h1>{{$contact['name'] }}</h1>
                        <h1>{{$contact['surname'] }}</h1>
                        <h3>{{$contact['email'] }}</h3>
                        <p>{{$contact['message'] }}</p>
                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="{{route('Index')}}" target="_blank">LugX</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>💃&nbsp; That's it. Enjoy this free gaming website.Go and download your favourite games.</p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    ...
                    <br> And <a href="{{route('Index')}}">unsubscribe link</a> here.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="{{route('Index')}}">LugX</a>.
                  </td>
                </tr>
              </table>
            </div>
